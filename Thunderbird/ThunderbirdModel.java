...
class ThunderbirdModel extends HttpRequest {
    // : ** Start Here ** and add the URL of the index file for your class here.
    // Hint: Consider using "https://thunderbird-index.azurewebsites.net/w0a6zk195d.json"
    // RS: Copied and pasted link.
            ...
            for (String line : urlContent) {
                ...
                if (subString.length >= 11) {
                    if (subString[11].indexOf("https://") > -1) {
                        ...
                        //     added.
                        // RS: Added check for a contactList with size 0 that sets returnValue to false. 
                        returnValue = true;
                    }
                }
            }
